...
* tables - Builds one or more HTML tables from a supplied array of arrays (each array holding the params specified for the table method)
...
Examples:
  ...
  footers = ['x','y','z']
  rows=[['d','e,'f']]
  HTML.table(:id=>'foo', :class=>'bar', :headers=>headers, :footers=>footers, :rows=>rows)
    =>
...
* comment - Return the text wrapped in an HTML comment
* wrap - Return the text wrapped in a tag pair
